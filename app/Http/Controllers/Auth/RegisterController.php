        ...
        $rules = [
            ...
            'card_id' => [
                ...
                function ($attribute, $value, $fail) {
                    $exists = ResearchStaffStudent::where('card_id', $value)->exists() ||
                            ResearchStaffProfessor::where('card_id', $value)->exists() ||
                            ResearchStaffResearchStaff::where('card_id', $value)->exists();
